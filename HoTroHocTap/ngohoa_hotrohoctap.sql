...
--
-- Host: localhost
-- Generation Time: Oct 21, 2018 at 09:20 PM
...
INSERT INTO `dm_nhomcauhoi` (`manhom`, `tennhom`, `ghichu`, `stt`) VALUES
...
(8, 3, 'thong bao nghi hoc', 'abbb', NULL, 2, '2018-10-21 17:55:11'),
(12, 1, 'bbb', 'bbb', NULL, 2, '2018-10-21 21:16:01');
...
(25, 2, 'de', 'Ai là người phát hành phiên bản đầu tiên của Linux', NULL),
(26, 2, 'de', 'Ai là người sở hữu Linux', NULL),
(27, 2, 'de', 'Điều nào sau đây sai khi nói về giấy phép Copyleft', NULL),
...
(97, 25, 'Linus Torvalds', NULL),
(98, 25, 'IBM', NULL),
(99, 25, 'Minix', NULL),
(100, 25, 'Richar stallman', NULL),
(101, 26, 'Linus Torvalds', NULL),
(102, 26, 'Không ai cả', NULL),
(103, 26, 'Minix', NULL),
(104, 26, 'Richar stallman', NULL),
...
('2', 'trinhthixuan', '202cb962ac59075b964b07152d234b70', 'Trịnh Thị Xuân', 1, 'giaovien'),
...
--
ALTER TABLE `dm_tintuc`
  MODIFY `matintuc` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `tbl_cauhoi`
  MODIFY `macauhoi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
-- AUTO_INCREMENT for table `tbl_cautraloi`
--
ALTER TABLE `tbl_cautraloi`
  MODIFY `macautraloi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
--
-- AUTO_INCREMENT for table `tbl_comments`
--
ALTER TABLE `tbl_comments`
  MODIFY `macomment` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
